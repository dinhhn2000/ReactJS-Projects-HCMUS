...
export const FETCH_OTHER_USER_PENDING = 'FETCH_OTHER_USER_PENDING';
export const FETCH_OTHER_USER_SUCCESS = 'FETCH_OTHER_USER_SUCCESS';
export const FETCH_OTHER_USER_ERROR = 'FETCH_OTHER_USER_ERROR';
...
export function fetchOtherUserPending() {
    return {
        type: FETCH_OTHER_USER_PENDING
    }
}

export function fetchOtherUserSuccess({email, name, avatar}) {
    return {
