...
export function fetchOtherUserAction(data) {
    return (dispatch) => {
        dispatch(fetchOtherUserPending());
        const profileUrl = apiUrl + "/me/otherUser";
        ...
        axios({
            ...
            .then(res => {
                ...
                if (res.data) {
                    ...
                    dispatch(fetchOtherUserSuccess(data));
                }
                else
                    dispatch(fetchOtherUserError({ error: "Cannot authenticate current user" }));
                return res.data.success;
            })
            .catch(err => {
                console.log(err);
                dispatch(fetchOtherUserError(err));
            })
    }
}
